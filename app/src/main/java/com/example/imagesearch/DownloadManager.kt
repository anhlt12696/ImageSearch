...
class DownloadManager(private val downloadLink: String, private val downloadPath: String, private val fileName: String, private val onDownloadProgressListener: OnDownloadProgressListener) : AsyncTask<String?, String?, String?>() {
